...
To *lib* folder contains functions that can be used to represent images as textons, and the ``example.m`` file illustrates how to use them. 
...
Reciba un cordial saludo ingeniero Diego, el presente correo se lo escribo por que soy consciente de que no voy a alcanzar a terminar los laboratorios de visión artificial, teniendo en cuenta que la semana santa no van a trabajar en la universidad quisiera pedirle el grande favor de que nos permita entregar los informes y el código para el primer día después de semana santa, para que podamos utilizar este tiempo para poder hacer un buen informe y poder comprender los métodos en la profundidad que lo exigen los laboratorios, de esta forma podríamos empezar después de semana santa con los laboratorios al día. Reconozco que usted ha sido muy paciente con nosotros, pero mi interés es poder aprender realmente el funcionamiento de los métodos. Creo que no soy el único que está con este problema. Le agradecería sinceramente que me diera el tiempo pues no soy muy hábil con matlab ni con los métodos de clasificación de los laboratorios. Agradezco su comprensión y colaboración.
